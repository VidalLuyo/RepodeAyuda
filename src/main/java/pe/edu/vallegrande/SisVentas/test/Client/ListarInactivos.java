...
public class ListarInactivos {
    public static void main(String[] args) {
        ...
        List<Clientes> inactiveClientes = clienteController.listarInactivos();

        if (!inactiveClientes.isEmpty()) {
            System.out.println("Clientes inactivos encontrados:");
            for (Clientes cliente : inactiveClientes) {
                System.out.println("------------------------");
            ...
            System.out.println("No se encontraron clientes inactivos.");
        }
    }
}
